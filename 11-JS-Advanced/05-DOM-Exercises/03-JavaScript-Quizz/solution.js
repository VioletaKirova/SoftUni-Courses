function solve() {
  ...
  function checkAnswer(answer) {
    if (
      rightAnswersMap.includes(
        answer.currentTarget.firstElementChild.firstElementChild.innerHTML
      )
    ) {
      rightAnswersCount++;
    }
  ...
  [...document.querySelectorAll(".quiz-answer")].forEach(x =>
